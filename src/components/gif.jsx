    ...
    <Link to={`${gif.type}/${gif.slug}`}>
        <div className='w-full mb-2 relative cursor-pointer'>
          ...
          className="w-full object-cover rounded transition-all duration-300" />
            ...
            {hover && <div className="absolute inset-0 rounded opacity-0 hover:opacity-100 transition-opacity duration-300 bg-gradient-to-b from-transparent via-transparent to-black to-emerald-200 font-bold flex items-end gap-2 p-2">
